...
return new class extends Migration
{
    ...
    {
        foreach (['reminders', 'calendar_sync_logs', 'video_meetings', 'meeting_room_bookings', 'meeting_rooms', 'calendar_event_reminders', 'calendar_event_attendees', 'calendar_events', 'calendars', 'renewal_reminders', 'renewal_history', 'renewal_items', 'renewals', 'client_issues', 'todo_lists', 'task_time_logs', 'task_assignments', 'task_watchers', 'task_dependencies', 'task_comments', 'task_checklist_items', 'task_checklists', 'project_expenses', 'project_time_logs', 'tasks', 'project_milestones', 'project_phases', 'project_members', 'projects'] as $table) {
